 ...
 * 
 */
public class NetconfProcessorEx implements Runnable, MessageQueueListener {
	...
	public NetconfProcessorEx(InputStream in, OutputStream out, OutputStream err, ExitCallback callback) {
		this.in = in;
		this.out = out;
		this.err = err;
						...
						if (message instanceof Query) {
							...
							if (behaviours != null) {
								...
								for (Behaviour b : behaviours) {
									if (b.getQuery().getMessageId().equals(query.getMessageId())) {
										behaviour = b;
										break;
									}
								}
