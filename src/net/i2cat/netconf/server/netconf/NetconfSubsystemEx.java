 ...
 * 
 */
public class NetconfSubsystemEx implements Command, SessionAware {

	private static final Log	log					= LogFactory.getLog(NetconfSubsystemEx.class);
	...
	private NetconfProcessorEx	netconfProcessor;
	private Thread				clientThread;

	public NetconfSubsystemEx(MessageStore messageStore, BehaviourContainer behaviourContainer) {
	...
	public void start(Environment env) throws IOException {
		...
		netconfProcessor = new NetconfProcessorEx(in, out, err, callback);
	...
	public static class Factory implements NamedFactory<Command> {
		...
		public Command create() {
			...
			return new NetconfSubsystemEx(messageStore, behaviourContainer);
		}
